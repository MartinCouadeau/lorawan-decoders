...
export function createRegistry(...vendors: Array<'milesight' | 'netvox' | 'ellenex'>): DecoderRegistry {
  const r = new DecoderRegistry();
  const sets = { milesight: MILESIGHT_MODELS, netvox: NETVOX_MODELS, ellenex: ELLENEX_MODELS };
